...
class CocoBase(Dataset):
    ...
    def __init__(self, size=None, dataroot="", datajson="", onehot_segmentation=False, use_stuffthing=False,
                 crop_size=None, force_no_crop=False, given_files=None, use_segmentation=False, crop_type=None, dataset_size=None):
        ...
        for imgdir in tqdm(imagedirs, desc="ImgToPath", disable=True):
        ...
        for capdir in tqdm(capdirs, desc="ImgToCaptions", disable=True):
        ...
        if dataset_size is not None:
            assert dataset_size < len(self.labels["image_ids"])
            self.labels['image_ids'] = self.labels['image_ids'][:dataset_size]
...
class CocoImagesAndCaptionsTrain2017(CocoBase):
    ...
    def __init__(self, size, onehot_segmentation=False, use_stuffthing=False, crop_size=None, force_no_crop=False, dataset_size=None,):
        super().__init__(size=size,
                         dataroot="data/coco/train2017",
                         datajson="data/coco/annotations/captions_train2017.json",
                         onehot_segmentation=onehot_segmentation,
                         use_stuffthing=use_stuffthing, crop_size=crop_size, 
                         force_no_crop=force_no_crop, dataset_size=dataset_size)
...
class CocoImagesAndCaptionsValidation2017(CocoBase):
    ...
    def __init__(self, size, onehot_segmentation=False, use_stuffthing=False, crop_size=None, force_no_crop=False,
                 given_files=None, dataset_size=None):
        super().__init__(size=size,
                         dataroot="data/coco/val2017",
                         datajson="data/coco/annotations/captions_val2017.json",
                         onehot_segmentation=onehot_segmentation,
                         use_stuffthing=use_stuffthing, crop_size=crop_size, force_no_crop=force_no_crop,
                         given_files=given_files, dataset_size=dataset_size)
